...
window.CONFIG = {
  ...
  APPS_SCRIPT_URL: "https://script.google.com/a/macros/gnk.or.kr/s/AKfycbyatoxmCp4qLKqzcUkmoOJLyJqJQSQQihVbCKmEORZejGBgJ9imqo9RFGr2k2lBHISfPA/exec",
  ...
  // 라이브 퀴즈쇼(quiz.html)가 열리는 시각 — 이 날짜/시각 이후로는 별도 종료시각 없이 계속 열려있습니다(상시오픈).
  // ※ 지금은 테스트를 위해 임시로 상시오픈(null) 처리해두었습니다. 실제 행사 때는 아래 주석을 해제하고
  //    null 대신 다시 { date: "2026-09-02", time: "11:10" } 로 되돌려주세요.
  QUIZ_OPEN_AT: null,
